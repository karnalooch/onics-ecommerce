...
import { PackageSearch, ChevronLeft, ChevronRight, Plus } from "lucide-react";
       ...
       <div className="flex flex-col xl:flex-row justify-between items-end xl:items-center gap-4">
          <div className="flex flex-wrap items-center gap-2">
             <Link
               ...
               className="h-10 px-6 bg-primary text-white font-bold text-[12px] flex items-center gap-3 active-press rounded-lg shadow-lg shadow-primary/20 transition-all hover:brightness-110"
             >
          ...
          <Table>
             <TableHeader className="bg-black/5 dark:bg-white/5 border-b border-black/5 dark:border-white/10">
                <TableRow className="hover:bg-transparent border-none">
                   ...
                   <TableHead className="hidden lg:table-cell py-5 px-4 min-w-[160px] text-center">
